<x-app-layout>
    ...
    <section class="md:h-[60vh] py-8 md:py-24 bg-primary-dark">
        <div class="h-full flex flex-col justify-center items-center px-4 md:px-10">
            <h1 class="sedan-regular-bold text-3xl md:text-6xl w-[50%] max-w-xl mx-auto mb-4 md:mb-10 text-center">
                Plans & Perks
            </h1>
            <p class="text-center text-md md:text-2xl max-w-3xl mx-auto">
                Whether you’re getting started or growing your portfolio, we’re here to back you up. The more you grow, the more perks you enjoy.
            </p>
        </div>
    </section>
    <!-- plans -->
    ...
    <section class="md:min-h-screen py-16 md:py-24 bg-gray-900 text-primary-light">
        <div class="px-6 md:px-16 grid grid-cols-1 md:grid-cols-5 gap-6 justify-center">
            <div class="col-span-1 md:col-span-3">
                <h2 class="text-3xl md:text-6xl sedan-regular max-w-xl">
                    Investing made simple —<br> with <span class="text-blue-600">stronger</span> security
                </h2>
            </div>
            <div class="col-span-1 md:col-span-2">
                ...
                $features = [
                [
                'heading' => 'Easy Investing',
                'description' =>
                'Our simple platform and friendly team help you every step of the way — from your first deposit to withdrawals and even retirement planning. No stress, just steady growth.',
                ],
                [
                'heading' => 'Smarter Money Moves',
                'description' =>
                'Benefit from automatic reinvestment, compounding returns, and free expert guidance — all working quietly in the background to help you stay on track.',
                ],
                [
                'heading' => 'Better Returns',
                'description' =>
                "At $appName, we blend smart data and real expertise to help you grow your money faster — with strategies that aim to beat the market again and again.",
                ],
                ];
                ...
                <div class="flex flex-col mb-6 md:mb-10">
                    <h4 class="futura-medium text-md md:text-2xl tracking-wider flex gap-4 flex-nowrap">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="20" height="20"
                            fill="currentColor" class="h-8 w-8 text-emerald-600">
                            <path
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 items-center gap-6 px-6 md:px-10">
            ...
            <div class="col-span-1 md:col-span-2">
                <h2 class="sedan-regular text-3xl md:text-6xl mb-4 w-full md:max-w-[85%]">
                    Smarter Ways to Grow Your <span class="text-blue-600">Money</span>
                </h2>
                <p class="text-md md:text-2xl mb-4 md:mb-10 w-full md:max-w-[85%]">
                    We take the time to understand your goals and how much risk you’re comfortable with. Once we know what you’re aiming for, we’ll guide you step by step into a Managed Portfolio with {{ $appName }} — making things clear, simple, and designed around you.
                </p>
                <div class="flex">
    ...
    <section class="bg-primary-light bg-cover" style="background-image: url('images/managedInvesting/low-fees.jpg')">
        <div
            ...
            <div class="max-w-lg mx-auto flex flex-col items-center justify-center text-center">
                <h2
                    class="max-w-2xl mx-auto md:w-full text-center sedan-regular text-4xl md:text-6xl text-primary-lighter mb-10">
                    Flexible Plans That Fit Your <span class="text-indigo-600">Goals</span>
                </h2>
                <p class="max-w-xl mx-auto md:w-full futura-book text-md md:text-2xl mb-10 text-primary-lighter">
                    Open your {{ $appName }} account today and start putting your money to work.
                </p>
