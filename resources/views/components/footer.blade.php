                ...
                <div class="w-full md:w-1/2 mb-6 md:mb-0">
                    <div class="max-w-sm flex flex-col">
                        ...
                        <p class="futura-book text-md">
                            Subscribe to our weekly newsletter for engaging updates on money, markets, and more — never
                            boring, always insightful.
                        </p>
                    </div>
                </div>
            ...
            <div class="w-full py-10 border-b border-gray-300">
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 justify-center">
                    ...
                    <div class="col-span-2 md:col-span-2 lg:col-span-2">
                        ...
                        <p class="futura-book text-md">
                            We’re a full-service investment firm dedicated to providing diverse opportunities that help
                            you invest with confidence. Whether you’re new to investing or an experienced investor,
                        ...
                        <div class="mt-4">
                            ...
                            <div class="mt-2 text-sm flex flex-col gap-4">
                                <a href="{{ config('app.socials.whatsapp_link') }}" class="flex items-center">
                                    <svg class="size-7 text-primary-light mr-2" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <a href="mailto:{{ config('mail.mainTo.address') }}" class="flex items-center">
                                    <svg class="size-7 mr-2 text-primary-light" xmlns="http://www.w3.org/2000/svg"
                                        width="32" height="32" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round">
                                        <path
