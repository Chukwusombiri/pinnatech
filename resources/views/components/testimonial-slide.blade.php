    ...
    <div class="mx-auto max-w-8xl px-4 py-12 sm:px-6 lg:me-0 lg:py-16 lg:ps-8 lg:pe-0 xl:py-24">
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3 lg:items-center lg:gap-16">
            <div class="max-w-xl text-center sm:text-left">
                <h6 class="text-md mb-4 font-light text-primary text-opacity-90 tracking-wider uppercase">Client Reviews</h6>
                <h2 class="text-3xl sedan-regular-bold tracking-wide text-gray-200 sm:text-4xl md:text-5xl">
                    Don’t Just Take Our Word for It
                </h2>

                <p class="mt-4 text-gray-400">
                    Hear directly from our clients — their experiences say more than we ever could about how we work and the results we deliver.
                </p>
